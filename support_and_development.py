...
plt.text(0, 1.28, '4. MTD Working Area Wise Percentage', ha='center',color='#3238a8', fontsize=14, fontweight='bold')
ax.axis('equal')
plt.legend(handles=legend_element, loc='upper right', fontsize=9)

plt.tight_layout()
plt.savefig('MTD_SupportvsDevelopment.png')
#plt.show()
plt.close()
print('4. MTD Working Area Wise Percentage generated')
