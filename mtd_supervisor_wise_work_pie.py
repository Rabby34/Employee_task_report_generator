...
plt.legend(patches, labels, loc='upper right', bbox_to_anchor=(1.35,.92),
           fontsize=9)
plt.text(0.1, 1.4, '13. MTD Working Hour according to supervisor', ha='center',color='#3238a8', fontsize=14, fontweight='bold')
#plt.title('Working Hour Percentage Per Company',fontsize='14',color='white', fontweight='bold',backgroundcolor='#6a9aba')
plt.tight_layout()

#plt.show()
plt.savefig('MTD_working_hour_according_to_supervisor.png')
plt.close()
