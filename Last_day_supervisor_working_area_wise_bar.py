...
plt.title('11. Last Day Supervisors Working Area Wise Hour', ha='center',color='#3238a8', fontsize=14, fontweight='bold')

#plt.xlabel('Employee', fontsize=14)
plt.ylabel('Work Hour', fontsize=14)
plt.tight_layout()
plt.savefig('last_day_supervisor_working_area_wise_bar.png')
#plt.show()
plt.close()
print('11. Last Day Supervisors Working Area Wise Hour')