...
plt.title('14. MTD Supervisors Working Area Wise Hour', ha='center',color='#3238a8', fontsize=14, fontweight='bold')

#plt.xlabel('Employee', fontsize=14)
plt.ylabel('Work Hour', fontsize=14)
plt.tight_layout()
plt.savefig('mtd_supervisor_working_area_wise_bar.png')
#plt.show()
plt.close()
print('14. MTD Supervisors Working Area Wise Hour')